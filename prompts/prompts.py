"""
Prompt templates for the IterResearch agent.

These prompts guide the agent through iterative research tasks with:
...
- **Tag pair must be complete** and not truncated.
